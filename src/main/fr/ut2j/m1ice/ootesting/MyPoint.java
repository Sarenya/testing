...
public class MyPoint {
	...
	/**
	 * Constructor 3 Creates a point from a IMyPoint. (0,0) will be used when the
	 * given pt is null.
	 * 
	 * @param pt
	 ...
	 * 
	 * @param newX
	 *            The new X coordinate. Must be valid (not equal Double.NaN),
	 ...
	 * 
	 * @param newY
	 *            The new Y coordinate. Must be valid (not equal Double.NaN),
	 *            otherwise nothing is done.
	 */
	...
	/**
	 * Computes the angle of the given point where the calling point is used as the
	 * gravity centre.
	 * 
	 * @param pt
	...
	/**
	 * Translates the point. If one of the given coordinate is not valid
	 * (Double.NaN), the translation does not occur.
	 * 
	 * @param tx
	 *            The X translation.
	 * @param ty
	 ...
	 * 
	 * @param random1
	 *            The random number generator used for x.
	 * @param random2
	 *            The random number generator used for y.
	 */
	 ...
	 * 
	 * @param translation
	 *            The translation vector. If null, nothing is performed.
	 */
